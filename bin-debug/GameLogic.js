...
var GameLogic = (function () {
    ...
    GameLogic.prototype.removeAniOver = function (evt) {
        var len = Linklogic.lines.length; //存放消除的数据，遍历当前已被消除的元素的长度
        var rel;
        for (var i = 0; i < len; i++) {
            var etype = "";
