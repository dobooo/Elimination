...
class GameOverPanel extends egret.Sprite{
	...
	private _issuccess:boolean = false;//游戏是否过关了
	public show(issuccess:boolean){//调用show时，传入参数游戏是否过关了
	...
	private playStarAni() {
		...
		*/
		...
		//成功动画
		if(this._issuccess){
			var success1:egret.Bitmap = new egret.Bitmap();
			...
			var success2:egret.Bitmap = new egret.Bitmap();
			...
			var fault1:egret.Bitmap = new egret.Bitmap();
			...
			var fault2:egret.Bitmap = new egret.Bitmap();
